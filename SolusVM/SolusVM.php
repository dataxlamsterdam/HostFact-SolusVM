...
class SolusVM
{
    ...
    public function getTemplateList()
    {
    	 ...
    	 */
        $response = json_decode($this->doCall(['action' => 'list-plans', 'type' => 'openvz', 'rdtype' => 'json']), true);
    ...
    public function getImageList()
    {
    	 ...
    	 */
        $response = $this->doCall(['action' => 'listtemplates', 'listpipefriendly' => true, 'type' => 'openvz']);
        ...
        if($response)
        {
            ...
            foreach(explode(',', $response['templates']) as $image)
            {   
                $image = explode('|', $image);
